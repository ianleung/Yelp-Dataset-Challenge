...
def json_to_sql(infile, outfile):
	with open(outfile, 'wb+') as fout:
		setup = "DROP TABLE IF EXISTS Review; CREATE TABLE Review(user_id VARCHAR(100),review_id VARCHAR(100),review_text VARCHAR(10000), votes__cool INT, business_id VARCHAR(100),votes__funny INT, stars INT, review_date DATE, type VARCHAR(10), votes__useful INT) ENGINE= MyISAM; "
		fout.write(setup)
...
if __name__ == '__main__':
	...
	outfilename = 'yelpscript.sql'
	json_to_sql("/Users/ruopingxu/TEMPORARY/" + infilename,
