...
TABLEFILE = 'yelp_dataset_challenge_academic_dataset/yelp_academic_dataset_business.json';
...
def create_tables_in_sql():
    ...
    string = "DROP TABLE IF EXISTS "+ TABLE +"; CREATE TABLE `" + TABLE + "` (`type` VARCHAR(100), `business_id` VARCHAR(100), `name` VARCHAR(100), `full_address` VARCHAR(1000), `review_count` INT, `city` VARCHAR(1000),`state` VARCHAR(1000), `latitude` INT, `longitude` INT, `stars` FLOAT(10,2),`open` VARCHAR(10));\n"
